            ...
            <nav class="navbar navbar-expand-md navbar-light bg-body-tertiary">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item"><?php var_dump($this->uri->segment(1));?>
                            <a class="nav-link <?php if($this->uri->segment(1)=="home"){echo "active";}?>" aria-current="page" href="<?= base_url() ?>">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link<?php if($this->uri->segment(1)=="gallery"){echo "active";}?>" href="<?= base_url('gallery') ?>">Tournament Gallery</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link<?php if($this->uri->segment(1)=="tournaments"){echo "active";}?>" href="<?= base_url('tournaments') ?>">My Tournament Dashboard</a>
                        </li>
                    </ul>
                </div>
