...
<body>
    <p>Hi <?= esc($username) ?>,</p>
    <p>The availability of tournament <strong><?= $tournament->name ?></strong> (<?= base_url("tournament/$tournament->id/view") ?>) hosted by <?= $creator->username ?> (<?= $creator->email ?>) has been updated to the following new START/END Date/Time.</p>
