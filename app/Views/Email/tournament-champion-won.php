...
<body>
    <p>Hi <?= esc($username) ?>,</p>
    <p>🏅 Congratulations! You have won the tournament <strong><?= $tournament->name ?></strong> (<?= base_url("tournament/$tournament->id/view") ?>) hosted by <?= $creator->name ?> (<?= $creator->email ?>) and claimed the top spot! Your hard work, strategy, and skill have led you to victory.</p>
