...
<body>
    <p>Hi <?= esc($username) ?>,</p>
    <p>The <strong><?= $tournament->name ?></strong> (<?= base_url("tournament/$tournament->id/view") ?>) hosted by <?= $creator->name ?> (<?= $creator->email ?>) has officially started, and you're in the action! Get ready to track the progress. </p>
