...
<div class="text-center align-middle">
    ...
    <div class="d-flex justify-content-center mb-3">
        <p class="home-content">
            ...
            <a class="btn btn-success" href="<?= base_url('/tournaments/create') ?>">Create Tournament</a>
        </p>
    </div>
    <div class="d-flex justify-content-center mb-3">
        <p class="home-content">
            Here to spectate? Visit the Tournament Gallery!<br />
            <a class="btn btn-purple" href="<?= base_url('/gallery?filter=glr') ?>">Teleport to Gallery</a>
        </p>
    </div>
    <div class="d-flex justify-content-center mb-3">
        <p class="home-content">
            Feeling the hype? Checkout the top contestants on the Participant Leaderboard!<br />
            <a class="btn btn-orange" href="<?= base_url('/participants') ?>">Check Leaderboard</a>
        </p>
    </div>
    <div class="d-flex justify-content-center mb-3">
        <p class="home-content">
            ...
            <a class="btn btn-warning" href="<?= base_url('/tournaments') ?>">My Tournament Dashboard</a>
        </p>
    </div>
</div>
<?= $this->endSection() ?>