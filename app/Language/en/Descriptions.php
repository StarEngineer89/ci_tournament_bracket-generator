...
return [
    ...
    'tournamentVotingMaxVotesDesc' => 'Winning participants automatically advance when the vote limit is reached each round. The max votes limit per bracket participant below.',
